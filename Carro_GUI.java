...
public class Carro_GUI extends Driver{
	...
	private void initialize() {
		...
		bmas = new JButton("->");
		bmas.addActionListener(new Listener());
		bmas.setBounds(66, 87, 45, 33);
		frame.getContentPane().add(bmas);
		
		bmenos = new JButton("<-");
	    bmenos.addActionListener(new Listener());
		bmenos.setBounds(17, 87, 45, 33);
		frame.getContentPane().add(bmenos);
